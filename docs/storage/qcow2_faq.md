...
- Maximum size a bit under 16TiB (16381 GiB, will change in the future but will be different depending on SR types)
...
he current limit is set to 16381 GiB. It's currently the lower limit that a EXT SR can support and is on all SR types to allow migration between SRs. We will raise it progressively in the future.
